...
public class CheckVotingEligibility extends HttpServlet{
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)throws ServletException,IOException{
		...
		if(age>=18)
			pw.println("<h1 style='color:maroon;text-align:center'>"+name+" is eligible for voting"+ "</h1>");

		else
			pw.println("<h1 style='color:maroon;text-align:center'>"+name+" is not eligible for voting, wait for "+(18-age)+"year."+ "</h1>");
